...
const requiredProperties = [
  ...
  // toValidate.spouse.name is required to be defined and
  // not null or an empty string.
  // Use a custom error message if the property is invalid
  {
    required: 'spouse.name',
    invalidValues: [''],
    error: {message: 'spouse is required and must contain a name'},
  },
  ...
  // Use a custom error message if the property is invalid.
  {
    required: 'spouse.age',
    invalidValues: [NaN],
    error: {message: 'spouse is required and must contain an age'},
  },
  // one of toValidate.notThere or toValidate.alsoNotThere is
  // required to be defined and not null
