...
describe('jsonObjectValidator', () => {
    ...
    it('should return valid: false if the object is missing a required' +
        ...
        'property if one is provided', () => {
            ...
            expect(validationObject.valid).toBe(false);
            expect(validationObject.errors).toEqual(
                ['Missing notThere property']
            );
        });

    it('should return valid: false if the object has a required parameter,' +
    ...
    it('should return valid: true if a propertyDescriptor provides an array' +
    ...
    it('should return valid: false and a message in the errors array if a' +
        ...
        'and none of the properties is valid', () => {
            ...
            expect(validationObject.errors).toEqual(
                [
                    {
                        message: 'Object must contain a valid' +
                        ' value for notThere or a.h',
                    },
                ]
            );
        });

    it('should return valid: false and a correctly formatted message for' +
        ' more than two invalid properties', () => {
            ...
            expect(validationObject.errors).toEqual([
                {
                    message: 'Object must contain a valid value for' +
                    ' notThere, alsoNotThere, or a.h',
                },
            ]);
        });

    it('should stop after finding one invalid property if' +
        ' lazy is set to true', () => {
            propertyDescriptors.push({required: 'notThere'});
            propertyDescriptors.push({required: 'a.h'});

            let validationObject = validate(obj, propertyDescriptors, true);
    ...
    it('should not stop after finding one invalid property if' +
        ' lazy is not true', () => {
            propertyDescriptors.push({required: 'notThere'});
            propertyDescriptors.push({required: 'a.h'});
